...
class Renta(models.Model):
    id_renta = models.CharField( max_length=10, primary_key=True, verbose_name='Identificador de renta', editable=False)
    ...
    estado = models.CharField(max_length=20, choices=[('R', 'Rentado'), ('D', 'Devuelto'), ('T', 'Devuelto tarde'), ('P', 'Sin devolve aun')], default='R', verbose_name='Estado de la renta')
